...
<template>
  <transition name="slide-up">
    <div v-if="visible && device" class="bottom-electric-blanket-bar" @click.stop>
      <div class="electric-blanket-bar-content">
        <!-- 电源按钮 -->
        ...
        <div class="device-name-wrapper">
          <span class="device-name">{{ device.name }} · 电热毯</span>
        </div>
      </div>
    </div>
  </transition>
