...
<template>
  <transition name="slide-up">
    <div v-if="visible && device" class="bottom-lamp-bar" @click.stop>
      <div class="lamp-bar-content">
        <!-- 左侧电源按钮 -->
        ...
        <div class="device-name-wrapper">
          <span class="device-name">{{ device.name }} · 台灯</span>
