...
<template>
  <transition name="slide-up">
    <div v-if="visible && device" class="bottom-wifi-extender-bar" @click.stop>
      <div class="wifi-extender-bar-content">
        <div 
          class="control-btn"
        ...
        <div class="device-name">{{ device.name }} · WiFi放大器</div>
      </div>
    </div>
  </transition>
</template>
