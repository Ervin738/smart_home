...
import BottomPowerBar from '@/features/device/components/BottomPowerBar.vue'
import BottomWashBar from '@/features/device/components/BottomWashBar.vue'
import BottomRobotBar from '@/features/device/components/BottomRobotBar.vue'
import BottomRackBar from '@/features/device/components/BottomRackBar.vue'
import TimerNotification from '@/features/device/components/TimerNotification.vue'
import DeviceDialog from '@/features/device/components/DeviceDialog.vue'
import SocketDialog from '@/features/device/components/SocketDialog.vue'
import TimerDialog from '@/features/device/components/TimerDialog.vue'
import CountdownDialog from '@/features/device/components/CountdownDialog.vue'
import PowerDetailDialog from '@/features/device/components/PowerDetailDialog.vue'
